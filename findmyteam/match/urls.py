...
urlpatterns = [
    ...
    url(r'^person_searching_team/$', views.person_searching, name='person_searching_team'),
    url(r'^person_searching_team_result/$', views.person_searching_result, name='person_searching_team_result'),
