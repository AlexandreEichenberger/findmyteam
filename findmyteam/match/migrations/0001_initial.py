# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-03-10 16:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('username', models.CharField(default='', editable=False, max_length=200)),
                ...
                ('child_interest', models.TextField(help_text="Enter your child's interest and relevant experience. Write description to read as a paragraph.", max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('first_program', models.CharField(choices=[('-', '-'), ('J', 'jFLL'), ('L', 'FLL'), ('T', 'FTC'), ('R', 'FRC')], default='-', max_length=1, validators=[match.models.validate_first_program])),
                ('username', models.CharField(default='', editable=False, max_length=200)),
                ...
                ('description', models.TextField(help_text="Enter a brief team's description and include your team's objectives. Write description to read as a paragraph.", max_length=2000)),
                ('achievement', models.TextField(help_text='Describe your recent achievements. Write description to read as a paragraph.', max_length=1000)),
